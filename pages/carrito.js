        ...
        <Layout pagina={'Carrito de compras'}>
            ...
            <main className={`${styles.contenido} contenedor`}>
                            ...
                            <div key={producto.id} className={styles.producto}>
                                ...
                                <div>
                                    ...
                                    <div className={styles.cantidad}>
                                        <p>Cantidad:</p>
                                        <select value={producto.cantidad} className={styles.select} onChange={e => actualizarCantidad({ cantidad: e.target.value, id: producto.id })}>
                ...
                <div className={styles.resumen}>
                    {total > 0 ? (
                        <>
                            <h3 className={styles.center}>Resumen del pedido</h3>
                            <p>- Total productos: ${total}</p>
                            <p>- Envio: $ 500</p>
                            <p>- Total a pagar: ${total + 500}</p>
                            <div className={styles.center}>
                                <button className={styles.enlace}>Comprar</button>
                            </div>
                        </>
                    ) :
